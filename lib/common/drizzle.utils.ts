...
/**
 * This function returns a Connection injection token for the given DrizzleModuleOptions or connection name.
 * @param {DrizzleModuleOptions | string} [connection='default'] This optional parameter is either
 * a DrizzleModuleOptions or a string.
...
export function getConnectionName(options: DrizzleModuleOptions) {
